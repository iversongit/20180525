...
$.get('/house/hindex/',function (data) {
   if(data.code==200){
       var user_name_html = template('user_info_reg_log',{username:data.user_name});
       ...
       var swiper_house_html = template('swiper_house_image',{images:data.hlist});
       $('.swiper-wrapper').append(swiper_house_html);
       var mySwiper = new Swiper ('.swiper-container', {
           loop: true,
           autoplay: 2000,
           autoplayDisableOnInteraction: false,
